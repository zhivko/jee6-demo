...
public class Student implements Serializable {
	 ...
	 *            The student birth date.
	 */
	public Student(final String lastName, final String firstName, final Date birthDate) {
		this();
	...
	public final void validate() {
		...
		if (this.getLastName() == null) {
			throw new IllegalArgumentException("Le nom de famille ne doit pas être vide");
		}
		if (this.getBirthDate() == null) {
			throw new IllegalArgumentException("La date de naissance ne doit pas être vide");
		}
	}
